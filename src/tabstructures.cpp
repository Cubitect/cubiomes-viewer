    ...
    , thread(this)
{
    ...
    ui->treeWidget->setColumnWidth(C_STRUCT, 120);
    ui->treeWidget->setColumnWidth(C_COUNT, 50);
    ui->treeWidget->setColumnWidth(C_X, 65);
    ui->treeWidget->setColumnWidth(C_Z, 65);
...
void TabStructures::onAnalysisItemDone(QTreeWidgetItem *item)
{
    ...
    ui->treeWidget->resizeColumnToContents(C_DETAIL);
...
void TabStructures::on_treeWidget_itemClicked(QTreeWidgetItem *item, int column)
{
    (void) column;
    QVariant dat;
